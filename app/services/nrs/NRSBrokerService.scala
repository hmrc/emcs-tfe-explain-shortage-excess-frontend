...
import models.nrs.{ExplainShortageExcessNRSSubmission, IdentityData, NRSPayload}
...
class NRSBrokerService @Inject()(brokerConnector: NRSBrokerConnector,
  ...
  def submitPayload(submission: SubmitShortageExcessModel, ern: String)
    ...
    val submissionAsString = Json.stringify(Json.toJson(ExplainShortageExcessNRSSubmission(ern, submission)))
