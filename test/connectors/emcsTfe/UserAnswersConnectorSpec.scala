  ...
  ".get()" - {
    ...
    "should return a successful response" - {
      ...
      "when downstream call is successful and returns some JSON" in {
        ...
        MockHttpClient.get(url"${appConfig.emcsTfeBaseUrl}/user-answers/explain-shortage-or-excess/$testErn/$testArc")
  ...
  ".put()" - {
    ...
    "should return a successful response" - {
      ...
      "when downstream call is successful and returns some JSON" in {
        ...
        MockHttpClient.put(
          url = url"${appConfig.emcsTfeBaseUrl}/user-answers/explain-shortage-or-excess/$testErn/$testArc",
